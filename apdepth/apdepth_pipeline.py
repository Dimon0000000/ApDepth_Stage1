...
class ApDepthDepthOutput(BaseOutput):
    """
...
class ApDepthPipeline(DiffusionPipeline):
    """
    Pipeline for monocular depth estimation using ApDepth.
    ...
    def __call__(
        ...
        Returns:
            `ApDepthDepthOutput`: Output class for ApDepth monocular depth prediction pipeline, including:
